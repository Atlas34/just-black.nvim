...
---@alias Highlights table<string,Highlight>
  Theme.highlights = {
    ...
    SnacksNotifierTitleDebug  = { fg = c.grey1 },
    SnacksNotifierError       = { fg = c.fg, bg = transparent and c.none or c.bg },
    SnacksNotifierBorderError = { fg = util.blend_bg(c.redError, 0.4), bg = transparent and c.none or c.bg },
    SnacksNotifierIconError   = { fg = c.redError },
    SnacksNotifierTitleError  = { fg = c.redError },
    SnacksNotifierInfo        = { fg = c.fg, bg = transparent and c.none or c.bg },
    SnacksNotifierBorderInfo  = { fg = util.blend_bg(c.blue, 0.4), bg = transparent and c.none or c.bg },
    SnacksNotifierIconInfo    = { fg = c.blue },
    SnacksNotifierTitleInfo   = { fg = c.blue },
    SnacksNotifierTrace       = { fg = c.fg, bg = transparent and c.none or c.bg },
    SnacksNotifierBorderTrace = { fg = util.blend_bg(c.purple, 0.4), bg = transparent and c.none or c.bg },
    SnacksNotifierIconTrace   = { fg = c.purple },
    SnacksNotifierTitleTrace  = { fg = c.purple },
    SnacksNotifierWarn        = { fg = c.fg, bg = transparent and c.none or c.bg },
    SnacksNotifierBorderWarn  = { fg = util.blend_bg(c.orange, 0.4), bg = transparent and c.none or c.bg },
    SnacksNotifierIconWarn    = { fg = c.orange },
    SnacksNotifierTitleWarn   = { fg = c.orange },
    -- Dashboard
    SnacksDashboardDesc       = { fg = c.cyan },
    SnacksDashboardFooter     = { fg = c.blueLight },
    SnacksDashboardHeader     = { fg = c.greenPastel },
    SnacksDashboardIcon       = { fg = c.blueLight },
    SnacksDashboardKey        = { fg = c.orange },
    SnacksDashboardSpecial    = { fg = c.purple },
    SnacksDashboardDir        = { fg = c.black3 },
    -- Profiler
    SnacksProfilerIconInfo    = { bg = util.blend_bg(c.blueLight, 0.3), fg = c.blueLight },
    ...
    SnacksInputTitle          = { fg = c.green },
    -- Picker
    SnacksPickerInputBorder   = { fg = c.greenBlue, bg = c.bg },
    SnacksPickerInputTitle         = { fg = c.greenBlue, bg = c.bg },
    SnacksPickerBoxTitle         = { fg = c.greenBlue, bg = c.bg },
    SnacksPickerSelected    = { fg = c.pink},
    SnacksPickerToggle         = { bg = util.blend_bg(c.blueLight, 0.1), fg = c.blue },
